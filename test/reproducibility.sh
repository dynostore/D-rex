...
mkdir -p plot/drex_only/10_most_unreliable_nodes_MEVA_merged_365_0.9_250_max0_node_removal/
...
mkdir -p plot/drex_only/10_most_unreliable_nodes_MEVA_merged_365_0.99999_250_max0_node_removal/
