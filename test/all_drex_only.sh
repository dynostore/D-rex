...
#~ bash test/run_experiments_drex_only.sh 365 -1 drex/inputs/nodes/10_most_used_nodes.csv drex/inputs/data/FB_merged.csv 1 drex/inputs/nodes/no_supplementary_nodes.csv 0 0 0 drex/
#~ bash test/run_experiments_drex_only.sh 365 -1 drex/inputs/nodes/10_most_unreliable_nodes.csv drex/inputs/data/FB_merged.csv 1 drex/inputs/nodes/no_supplementary_nodes.csv 0 0 0 drex/
#~ bash test/run_experiments_drex_only.sh 365 -1 drex/inputs/nodes/most_used_node_x10.csv drex/inputs/data/FB_merged.csv 1 drex/inputs/nodes/no_supplementary_nodes.csv 0 0 0 drex/
#~ bash test/run_experiments_drex_only.sh 365 -1 drex/inputs/nodes/10_most_reliable_nodes.csv drex/inputs/data/FB_merged.csv 1 drex/inputs/nodes/no_supplementary_nodes.csv 0 0 0 drex/
#~ python3 plot/mininet/plot_size_stored_and_efficiency_different_set_of_nodes.py _FB_merged_365_-1.0_1_max0

#~ bash test/run_experiments_drex_only.sh 365 0.9 drex/inputs/nodes/10_most_used_nodes.csv drex/inputs/data/FB_merged.csv 1 drex/inputs/nodes/no_supplementary_nodes.csv 0 0 0 drex/
#~ bash test/run_experiments_drex_only.sh 365 0.99 drex/inputs/nodes/10_most_used_nodes.csv drex/inputs/data/FB_merged.csv 1 drex/inputs/nodes/no_supplementary_nodes.csv 0 0 0 drex/
#~ bash test/run_experiments_drex_only.sh 365 0.999 drex/inputs/nodes/10_most_used_nodes.csv drex/inputs/data/FB_merged.csv 1 drex/inputs/nodes/no_supplementary_nodes.csv 0 0 0 drex/
#~ bash test/run_experiments_drex_only.sh 365 0.9999 drex/inputs/nodes/10_most_used_nodes.csv drex/inputs/data/FB_merged.csv 1 drex/inputs/nodes/no_supplementary_nodes.csv 0 0 0 drex/
#~ bash test/run_experiments_drex_only.sh 365 0.99999 drex/inputs/nodes/10_most_used_nodes.csv drex/inputs/data/FB_merged.csv 1 drex/inputs/nodes/no_supplementary_nodes.csv 0 0 0 drex/
#~ python3 plot/mininet/plot_evolution_relibaility_threshold.py 10_most_used_nodes_FB_merged_365_ _1_max0

#~ bash test/run_experiments_drex_only.sh 365 0.9 drex/inputs/nodes/10_most_used_nodes.csv drex/inputs/data/IBM.csv 1 drex/inputs/nodes/no_supplementary_nodes.csv 0 0 0 drex/
#~ bash test/run_experiments_drex_only.sh 365 0.99 drex/inputs/nodes/10_most_used_nodes.csv drex/inputs/data/IBM.csv 1 drex/inputs/nodes/no_supplementary_nodes.csv 0 0 0 drex/
#~ bash test/run_experiments_drex_only.sh 365 0.999 drex/inputs/nodes/10_most_used_nodes.csv drex/inputs/data/IBM.csv 1 drex/inputs/nodes/no_supplementary_nodes.csv 0 0 0 drex/
#~ bash test/run_experiments_drex_only.sh 365 0.9999 drex/inputs/nodes/10_most_used_nodes.csv drex/inputs/data/IBM.csv 1 drex/inputs/nodes/no_supplementary_nodes.csv 0 0 0 drex/
