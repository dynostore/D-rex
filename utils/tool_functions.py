...
def get_set_of_N_on_pareto_front(number_of_nodes, reliability_threshold, reliability_of_nodes, file_size):
	N_on_pareto = []
...
set_of_N_on_pareto = get_set_of_N_on_pareto_front(N, reliability_threshold, p, file_size)
